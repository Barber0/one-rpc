...
func (o *onerpc) genService(svr *descriptor.ServiceDescriptorProto) {
	...
	o.P("}\n")
	o.P("func New",svrName,"(name string, addr ...string) (as *",svrName,", err error) {")
	o.P("    var sc *", rpcPkg,".ServiceController")
	o.P("    sc, err = ",rpcPkg,".NewServiceController(name, ",appProtoPkg,".NewClientProtocol,addr...)")
	o.P("    if err != nil {")
	o.P("    	return")
	o.P("    }")
	o.P("    as = &",svrName,"{")
